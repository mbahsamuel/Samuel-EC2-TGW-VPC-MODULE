...
variable "production_route_table_ids" {
  description = "Identifiers of EC2 Transit Gateway Route Tables to use with the Target Gateway when reusing it between multiple TGWs"
  type        = list(string)
  default     = []
}
...
variable "management_route_table_ids" {
  description = "Identifiers of EC2 Transit Gateway Route Tables to use with the Target Gateway when reusing it between multiple TGWs"
  type        = list(string)
  default     = []
}

variable "security_route_table_ids" {
  description = "Identifiers of EC2 Transit Gateway Route Tables to use with the Target Gateway when reusing it between multiple TGWs"
  type        = list(string)
  default     = []
}